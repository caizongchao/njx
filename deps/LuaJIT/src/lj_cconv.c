		   ...
		   TValue *o, uint8_t *sp)
{
  ...
  if(ctype_isgcptr(sinfo)) {
    GCobj * o = *(GCobj **)sp; intptr_t it = ~o->gch.gct;
    *(intptr_t *)o = ((intptr_t)o) | (it << 47); return 0;
  }
...
{
  if(ctype_isgcptr(d->info) && tvisgcv(o)) {
    *(intptr_t *)dp = (intptr_t)gcval(o); return;
  }
